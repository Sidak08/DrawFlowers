...
const genStem = (x, y, r, petalHeight, outterPetal) => {
  const offset = 8
  let stem = new bt.Turtle()
  ...
  const newStem = bt.cover([bt.catmullRom(stem.lines()[0])], outterPetal)
  drawLines(newStem)
}
...
const genFlower = (r, x, y, petalNum, petalHeight, innerPetalNum, innerPetalHeight, circleMorph, innerCircleMorph) => {
  ...
  genStem(x, y, r, petalHeight, outterPetal)
